...
int main(){
    ...
    //Prova - Exercicio 10
    double a[ROWS][COLS] = {{8.98633, 4.78636, -3.02902}, {2.8222, -8.38123, 4.38808}, {3.319, -2.08771, 6.57765}};
    double b[ROWS] = {2.31482, -1.67233, -2.85427};
    
    double chute[COLS] = {-3.28555, 2.92214, 1.65755};
